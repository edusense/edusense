...
session_video_file = f'{SESSION_DIR}/{SESSION_KEYWORD}/{SESSION_KEYWORD}-front.avi'
session_audio_file = f'/tmp/{SESSION_KEYWORD}.mp3'
...
OUT_FILE = f'{OUT_DIR}/{SESSION_KEYWORD}-front.pb'
...
print(f"Time taken end to end {t_end_transcription - t_start_transcription:3f} secs...")  # before alignment
